# Zanadrze metod i strategii - funkcja_ewolucyjny
...
- Algorytm genetyczny (GA): populacja, selekcja ruletkowa, krzyżowanie jednopunktowe, mutacja, elitarność
- Fitness: 1000 + 1000 * cos(x1)*...*cos(x5) (maksymalizacja do 2000)
...
- crossover(): krzyżowanie jednopunktowe. Tu wstawisz dwupunktowe i wielopunktowe (PMX/OX są z prezentacji, ale głównie dla permutacji)
- mutate(): mutacja addytywna z obcięciem do 0..PI. Tu wstawisz inne warianty mutacji
