# Zanadrze metod i strategii - funkcja_ewolucyjny_usredniajacy
...
- Algorytm genetyczny (GA) z krzyżowaniem uśredniającym (arytmetycznym) dla liczb rzeczywistych
- Selekcja ruletkowa, mutacja addytywna, elitarność, fitness oparty o sin (maksymalizacja do 1000)
...
- crossover(): krzyżowanie uśredniające. Tu możesz dodać dwupunktowe/wielopunktowe (dla real coded zwykle miesza się geny inaczej, ale slajdy wymieniają typy krzyżowania ogólnie)
- mutate(): mutacja. Tu wstawisz inne warianty i strojenie zakresu mutacji
