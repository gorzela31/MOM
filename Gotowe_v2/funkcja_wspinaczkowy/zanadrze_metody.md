# Zanadrze metod i strategii - funkcja_wspinaczkowy
...
- Local search: algorytm wspinaczkowy (hill climbing) dla 5 zmiennych rzeczywistych w zakresie 0..PI
- Mały krok zmiany jednej zmiennej, akceptacja tylko jeśli fitness rośnie

## Gdzie wpiąć alternatywy w obecnym kodzie
- generuj_nowego(): tworzenie sąsiada przez zmianę jednej współrzędnej. Tu dopiszesz inne kroki/perturbacje
- select(): akceptacja poprawy. Tu możesz zrobić inne reguły wyboru z sąsiedztwa
- pętla w main: tu wpinają się multi-start / iterated local search / VNS
